...
│                         heart_disease_template and configuration for tools like black
│
...
│
└── heart_disease_template   <- Source code for use in this project.
    │
    ├── __init__.py             <- Makes heart_disease_template a Python module
    │
